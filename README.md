...
投影方式を変更すると、その方式に保存された画角と中心位置が`Intrinsics`へ反映されます。入力源やビデオフォーマットを変更した場合は、実際に開かれたフレームの解像度だけを更新し、投影方式固有の画角と中心位置は保持します。
...
- 投影方式変更後に、キャプチャ開始や入力切り替えで画角・中心位置が失われないこと。
...
詳細な開発方針は`GEMINI.md`、変更要求と対応履歴は`REQUESTS.md`を参照してください。
